        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            >
              ...
              <span>Add Clients &RightArrow;</span>
            </a>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold"><?php echo $row_client['client_id']; ?></p>
                      ...
                      <td class="px-4 py-3 text-sm">
                        <?php echo $row_client['birth_date']; ?>
                      </td>
                      <td class="px-4 py-3 text-sm">
                      <?php echo $row_client['nid']; ?>
                      </td>
                      <td class="px-4 py-3 text-sm">
                      <?php echo $row_client['phone']; ?>
                      </td>
                      <td class="px-4 py-3 text-sm">
                        <?php echo $row_client['address']; ?>
                      </td>
                      <td class="px-4 py-3 text-xs">
                        <form action="clientStatus.php">
                        <button type="submit">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          ...
                          <input type="hidden" name="client_id" value="<?php echo $row_client['client_id']; ?>">
                          <button type="submit"
